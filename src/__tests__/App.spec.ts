...
describe('App', () => {
  ...
  it('should not be able to create a customer with email thats already added', async () => {
  ...
  it('should not be able to create a customer with e-mail thats already added', async () => {
